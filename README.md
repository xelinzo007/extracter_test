...
4. **Pin the Extension (Optional)**
   ...
   - Find "pdfcreater" and click the pin icon to keep it visible
...
2. **Extract Flight Data**
   - Click the pdfcreater icon in your Chrome toolbar
...
3. Click the reload icon (🔄) on the pdfcreater card
4. Test your changes
